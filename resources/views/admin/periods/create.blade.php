                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="period_number" id="period_number" value="{{ old('period_number', 1) }}" required min="1" max="10"
                                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    @error('period_number')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <label for="enrollment_start" class="block text-sm font-medium text-gray-700">Inschrijving start (optioneel)</label>
                                    <input type="datetime-local" name="enrollment_start" id="enrollment_start" value="{{ old('enrollment_start') }}"
                                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                ...
                                <div>
                                    <label for="enrollment_end" class="block text-sm font-medium text-gray-700">Inschrijving einde (optioneel)</label>
                                    <input type="datetime-local" name="enrollment_end" id="enrollment_end" value="{{ old('enrollment_end') }}"
                                           class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
